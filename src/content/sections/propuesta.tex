...
\begin{equation} o_k=\sum^{N_j}_{j=1}w_{jk}\sigma(\sum^{N_i}_{i=1}w_{ij}n_i+\theta_j)+\theta_k \end{equation}
...
\begin{equation} \Psi(x)=A(x)sen[S(x)]\label{fonda}\end{equation}
